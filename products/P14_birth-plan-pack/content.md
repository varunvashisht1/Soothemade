...
*Sixteen pages of worksheets the nurse can actually use. Built like a real adult is going to read them, not like a glossy template that fills the room but says nothing.*
...
SUPPORT PERSON:      _____________________________________
   Their role:       _____________________________________
   Their phone:      _____________________________________
...
PRONOUNS I USE:      __________________________________
PRONOUNS I'D LIKE
PEOPLE TO USE FOR
THE BABY (IF I HAVE
A PREFERENCE):       __________________________________

PRIOR BIRTH EXPERIENCE
IF ANY (one sentence): ________________________________
─────────────────────────────────────────────────────────
```
...
```
   ...
   IMPORTANT: I want the option to change my mind in either
   direction without being asked "are you sure" repeatedly.
```
...
```
   ...
   ☐ No need.
   ☐ I am keeping it for ___________________________ (research,
     encapsulation, burial, art). I will bring my own container.
```
...
```
   ...
   After delivery (no one else until I'm ready):
      ...
      ☐ Plus: ______________________________________
...
```
   ☐ My playlist
   ☐ Voice of: _________________________________
   ☐ Silence
...
```
   ...
   ☐ No strong smells
   ☐ A specific food or drink: _______________________
```
...
```
   ...
   ☐ A clear conversation about what's happening, narrated
...
```
   ...
   Decision-maker if I cannot speak: _______________________

   Their phone: ______________________________________

   My next-of-kin (different from above, if applicable):
                                ______________________

   Religious or spiritual care:
   ☐ Yes, please call: __________________________________
   ☐ No, thank you
   ☐ Only if I ask
```
...
HOSPITAL OR BIRTH CENTER
   ...
   Name: ___________________   Address: ________________
   Labor & delivery direct:    __________________________
   Where to park:              __________________________
...
PEOPLE WHO ARE COMING (in order of arrival)
   ...
   1. ___________________  Their phone: _______________
   2. ___________________  Their phone: _______________
...
```
   ...
   ☐ No interruptions: no visitors, no calls, no photos beyond
     my partner's, no announcement to family
